...
const Dialog = () => {
    ...
    { showPrivacyDialog ? (<PrivacyDialog />) :
        ...
        (<div className={`${theme.dialogBg} max-w-[400px] ${theme.dialogTextColor} font-switzer rounded-xl z-10 absolute flex flex-col items-center p-4 px-6 gap-4`}>
       <div className="w-full">
        ...
        <div className="flex w-full items-center justify-between">
            ...
            <p className="w-full text-sm font-medium">a lightweight internet text area to park your thoughts.</p>
            <div className="w-full grid grid-cols-2 gap-3 text-sm text-center font-jetbrains-mono">
                <div className={`${theme.buttonBg} w-full ${theme.buttonText} rounded-md px-2 py-1 cursor-pointer`} onClick={handlePrivacyDialog}>privacy</div>
                <div className={`${theme.buttonBg} w-full ${theme.buttonText} rounded-md px-2 py-1 cursor-pointer`} onClick={handleAboutDialog}>about</div>
                <div className={`${theme.buttonBg} w-full ${theme.buttonText} rounded-md px-2 py-1 cursor-pointer`} onClick={handleThemeDialog}>theme</div>
                <a className={`${theme.buttonBg} w-full flex items-center justify-center gap-1 ${theme.buttonText} rounded-md px-2 py-1 cursor-pointer`} href="https://github.com/volvotkar/kaagad/" target="_blank">github <ArrowUpRightIcon className="w-4"/></a>
            </div>
        
        <div className="flex gap-2 w-full">
        <div className={`w-full font-jetbrains-mono flex text-xs justify-center text-center items-center ${theme.buttonText} ${theme.buttonBg} rounded-md px-2`}>
